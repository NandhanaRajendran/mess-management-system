...
const StaffAdvisorDashboard = () => {
  ...
  // Filter students by department + batch
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute(
      "download",
      `pending_dues_${user?.department}_${user?.batch}.csv`
    );
    ...
    <header className="top-bar glass-panel">
      ...
      <div className="user-info">
        ...
        <div className="user-details">
          ...
          <p>
            Staff Advisor - {user?.department} (Batch: {user?.batch})
          </p>
        </div>
            ...
            <p>
              {
                filteredStudents.filter(
                  (s) => s.status?.trim().toLowerCase() === "paid"
                ).length
              }
            </p>
          </div>
